...
<%
    ...
    if (c != null) {
        try {
            i = Long.parseLong(c);
            if (i < 0) {
                //numero inicial a mostrar por cada llamada a registrar partida
                i = 1;
            } else {
                i++;
            }
    ...
    <div class="row mb-3" data-type="total-partida">
        <div class="col-md-5">
            <a data-type='btn-agregar' href="#">
                <i class="fa fa-plus text-primary"></i> Cargo/Abono
            </a>
            <a class="text-danger" data-type="btn-eliminar-ch" href="#"><i class="fa fa-trash"></i> Eliminar selección</a>
        </div>
        <div class="col-md-1 text-right">Totales:</div>
