...
public class ServletPartida extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      try (PrintWriter out = response.getWriter()) {
          ...
          * fechas[] un arreglo con las fechas en las que se realizan cada
          * partida
          *
          * A cada partida se le asignaran sus cargos y abonos. El registro de
          * partidas necesita los siguientes datos para esto: montos[] un
          * arreglo con las cantidades que se asignan en cargo o abono ops[] un
          * arreglo con las operaciones respectivas. "c" indica cargo, "a"
          * indica abono num-partidas[] el numero de partida respectivo al que
          * pertenece cada cargo / abono codigos-cuentas
          */
